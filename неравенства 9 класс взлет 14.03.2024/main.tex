...
\begin{document}
	\pagestyle{empty}
    \name{}
	\head{9 класс}{Неравенства}
	\bigskip

\task Для плодительных $a, b, c$ докаэите неравенство $$\frac{a}{b +c} + \frac{b}{a + c} + \frac{c}{a + b} \geq \frac{3}{2}$$
	
\task Для любых $a, b, c > 0$, удовлетворяющих условию $abc = 1$, докажите, что $$(ab)^2 + (ac)^2 + (bc)^2 \geq a + b + c$$
...
\task Пусть $a, b, c$ — положительные числа, сумма которых равна $1$. Докажите неравенство $$\frac{1}{1-a} + \frac{1}{1-b} + \frac{1}{1-c} \geq \frac{2}{1 + a} + \frac{2}{1 + b} + \frac{2}{1 + c}$$
