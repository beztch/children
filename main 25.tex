...
\task В классе все еще 20 человек, но теперь нужно выбрать команду, в которой должны быть тч-шник, комбинатор, геометр, алгебраист, отдыающий
...
\task Сколько различных чисел можно составить из цифр от $1$ до $9$ (каждая используется ровно $1$ раз) таким образом, чтобы никакие две нечетные цифры не стояли рядом?\\
